        ...
        <div className="px-5 lg:px-10 py-10">
            <div className="container mx-auto">
                <div className="mt-10 flex flex-col gap-3">
                    ...
                    <p>
                        Authors are requested to submit full-length papers
                        online using the following web link:
                    </p>

                    <a
                        href="https://cmt3.research.microsoft.com/SUSTAINED2024/"
                        className="text-secondary underline block break-all max-w-full"
                    >
                        https://cmt3.research.microsoft.com/SUSTAINED2024/{" "}
                    </a>
                </div>
                    ...
                    <table>
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <span className="line-through decoration-red-500 text-black">
                                        <strong>
