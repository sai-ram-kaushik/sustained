...
export const RenderMap = () => {
  return (
    <div className="container mx-auto ">
      <p className="text-xl text-black font-medium">Format as below</p>
      <div className="max-w-[1000px] min-h-[600px] bg-red-500 mx-auto mt-4 rounded-md">
        <p className="text-white text-xl text-center py-3">Contact Us:</p>
        <ul className="flex flex-col space-y-1 text-center gap-y-2">
          <li className="text-white text-xs mt-1">Mrs.Shruti, Mobile : 9872920600, Email: shruti.sod@mriu.edu.in</li>
          <li className="text-white text-xs mt-1">Mrs.Renuka, Mobile : 7982253319, Email: renuka.sod@mriu.edu.in</li>
          <li className="text-white text-xs mt-1">Mrs.Divya Garg, Mobile : 9899208437, Email: divyagarg.sod@mriu.edu.in</li>
        </ul>
        ...
        <div className="max-w-[800px] mx-auto mt-5 pb-5">
